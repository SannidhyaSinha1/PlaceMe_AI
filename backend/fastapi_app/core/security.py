...
async def require_complete_profile(
    ...
    """Gate features that need student data: 403 until the profile + CV are done.

    Admins are exempt — they manage opportunities rather than apply.
    """
    if user.is_admin:
        return user
    profile = (
    ...
    if profile is None or not profile.profile_complete:
        raise HTTPException(
            ...
            "Complete your profile and upload your CV to use this feature",
        )
    return user
